"""
Django settings for vybe_43822 project.
...
WSGI_APPLICATION = 'vybe_43822.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "vybe_43822 API",
    "DESCRIPTION": "API documentation for vybe_43822 App",
    "VERSION": "v1",
}
